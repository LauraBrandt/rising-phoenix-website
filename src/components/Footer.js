  ...
  return (
    <footer style={style.footer}>
      <div style={style.links}>
        ...
        <a href={props.links.facebook} style={style.facebookLogo} key="facebook"><i className="fa fa-facebook-square"></i></a>
        <a href={props.links.twitter} style={style.twitterLogo} key="twitter"><i className="fa fa-twitter-square"></i></a>
      </div>
