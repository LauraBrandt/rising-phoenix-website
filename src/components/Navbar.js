    ...
    <nav style={style.wide.navbar}>
      <ul style={style.wide.ul}>
        ...
        <li style={style.wide.socialButtons}>
          ...
          {props.links.instagram && <a href={props.links.instagram} style={style.wide.instagramButton} key="instagram"><i className="fa fa-instagram"></i></a>}
        </li>
      </ul>
    </nav>
  );
    ...
    return (
      <nav style={style.narrow.navbar}>
        <div style={style.narrow.topBar}>
          <img src="https://s3.us-east-2.amazonaws.com/risingphoenix/static/rising_phoenix_logo_sm.min.png" alt="Rising Phoenix logo" style={style.narrow.logo} />
